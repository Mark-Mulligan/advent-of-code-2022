...
resultArr.push(directory.sumContents());

const addSumToResult = (children: any[], result: number[]) => {
  children.forEach((child) => {
    if (child instanceof Directory) {
      result.push(child.sumContents());
...
// console.log(rootDirectory.children[0].sumContents());
// console.log(rootDirectory.sumContents());
